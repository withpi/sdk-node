...
import { APIUserAbortError } from '@2pir-ai/twopir';
import { Headers } from '@2pir-ai/twopir/core';
...
describe('instantiate client', () => {
  ...
  test('normalized method', async () => {
    ...
    const client = new Twopir({ baseURL: 'http://localhost:5000/', apiKey: 'My API Key', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Twopir({ baseURL: 'http://localhost:5000/custom/path/', apiKey: 'My API Key' });
    ...
    afterEach(() => {
      process.env['TWOPIR_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Twopir({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['TWOPIR_BASE_URL'] = 'https://example.com/from_env';
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Twopir({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Twopir({ apiKey: 'My API Key' });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Twopir({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Twopir({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Twopir({ apiKey: 'My API Key', fetch: testFetch });
