...
export class Grpo extends APIResource {
   ...
   */
  create(body: GrpoCreateParams, options?: Core.RequestOptions): Core.APIPromise<GrpoCreateResponse> {
 ...
 */
export interface GrpoCreateResponse {
  /**
...
export interface GrpoCreateParams {
   ...
   */
  lora_config: GrpoCreateParams.LoraConfig;
